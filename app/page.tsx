    ...
    <>
      <div className="md:flex md:flex-row-reverse md:mx-32 md:pt-32">
        ...
        <div className="mt-10 md:w-3/5">
          <div className="font-extrabold text-4xl text-center mt-3 md:text-left md:text-6xl ">Hi, I am John,<br />Creative Technologist</div>
      ...
      <div className="pt-10 flex justify-center md:justify-between m-2 md:mx-32">
        <div className="text-2xl font-bold">Resent posts</div>
